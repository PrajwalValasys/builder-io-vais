          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-3">
              <Button
                variant="outline"
                size="sm"
                onClick={() => setStickyFilters(!stickyFilters)}
              >
                <Pin
                  className={cn(
                    "w-4 h-4 mr-1",
                    stickyFilters && "text-valasys-orange",
                  )}
                />
                {stickyFilters ? "Unpin" : "Sticky"} Filters
              </Button>
              <Badge
                variant="secondary"
                className="bg-blue-50 text-blue-700 cursor-pointer hover:bg-blue-100"
                onClick={() => {
                  /* Open credit top-up flow */
                }}
              >
                <Target className="w-3 h-3 mr-1" />
                Prospects: <span className="font-bold ml-1">8,450</span>
              </Badge>
              <Badge
                variant="secondary"
              ...
              >
                ...
                Searches: <span className="font-bold ml-1">125</span>
              </Badge>
            </div>
          </div>
