    ...
    return (
      <div className="flex flex-wrap justify-center gap-6 mt-4">
        {payload.map((entry: any, index: number) => (
          <div
            key={index}
            className={`flex items-center space-x-2 cursor-pointer interactive-legend rounded-lg px-3 py-2 transition-all duration-200 hover:bg-gray-50 ${
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
          ...
          <div className="flex items-center space-x-3">
            <Select value={chartType} onValueChange={setChartType}>
              <SelectTrigger className="w-[160px] border-valasys-orange/20 hover:border-valasys-orange/40 focus:border-valasys-orange focus:ring-valasys-orange/20">
                <SelectValue />
              </SelectTrigger>
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 pt-6 border-t border-gray-100">
          <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-4 rounded-lg">
            <div className="flex items-center space-x-3">
              <div className="p-2 bg-white rounded-lg">
                <Users className="w-5 h-5 text-valasys-orange" />
              </div>
              <div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg">
            <div className="flex items-center space-x-3">
              <div className="p-2 bg-white rounded-lg">
                <Target className="w-5 h-5 text-valasys-blue" />
              </div>
              <div>
                <p className="text-sm font-medium text-gray-600">
                  Avg Success Rate
